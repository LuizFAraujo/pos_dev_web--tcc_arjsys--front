...
### 1.1 - Setup e Types
- [ ] Criar `types/cadastros/produto.types.ts`
  - [ ] Interface `Produto`
...
- [ ] Criar `types/shared/common.types.ts`
  - [ ] Type `Status`
  - [ ] Type `SortOrder`
  - [ ] Interface `Pagination`

- [ ] Criar `data/cadastros/mockProdutos.ts`
  - [ ] Array com 20 produtos
  - [ ] Mix de tipos (fabricado, comprado, matéria-prima)
  - [ ] Alguns com desenho, outros sem

### 1.2 - Store Zustand
- [ ] Criar `stores/cadastros/produtosStore.ts`
